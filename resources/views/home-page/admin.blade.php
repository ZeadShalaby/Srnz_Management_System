    ...
    @section('content')
        ...
        <div id="divshow" style="visibility: hidden;">
            ...
            <div class="main-content">
                                ...
                                <a class="nav-link pr-0" href="#" role="button" data-toggle="dropdown"
                                    ...
                                    <div class="media align-items-center" style="  margin-top: 35px;">
                                        <span class="avatar avatar-sm rounded-circle" style="  margin-top: -5px;">
                                            ...
                                            @else
                                                <img src="{{ asset('image/users/' . $SeAdmin->profile_photo) }}"
                                                    alt="Image users">
                                            @endif
                                        </span>
                ...
                <!-- Page content -->
                <form action="{{ route('users.update', $SeAdmin->id) }}" name="formseting" method="post"
                                                ...
                                                <a href="#">
                                                    @if (isset($SeAdmin->profile_photo))
                                                        <div class="profile-pic" style="margin-top: -150px">
                                                            ...
                                                            <img src="{{ asset('image/all/profileA.png') }}"
                                    ...
                                    <div class="card-body pt-0 pt-md-4">
                                        <div class="row">
                                            <div class="col">
                                                <div class="card-profile-stats d-flex justify-content-center mt-md-5">
                                                    <div>
                                                        <span class="heading"
                                                            style="color: rgb(190, 40, 120)">{{ $numorders }}</span>
                                                        <span class="description">orders</span>
                                                    </div>
                                                    <div>
                                                        <span class="heading"
                                                            style="color: rgb(190, 40, 120)">{{ $numfav }}</span>
                                        ...
                                        <div class="text-center">
                                            ...
                                            <p style="color: rgb(143, 141, 141)">Ryan — the name taken by Melbourne-raised,
                                                Brooklyn-based Nick
                                                Murphy — writes, performs and records all of his own music.</p>
                                            <a href="#">Show more</a>
                                        </div>
                                ...
                                <div class="card bg-secondary shadow">
                                    ...
                                    <div class="card-header bg-blue border-0">
                                        <div class="row align-items-center">
                                            ...
                                            <h3 class="mb-0" style="color: azure;font-weight: bold;margin-left: -560px">
                                                @if ($SeAdmin->role == 1)
                                                    Gender : Admin
                                                @else
                                                    Gender : Customer
                                    ...
                                    <div class="card-body" style="background-color: rgb(35, 35, 36)">
                                        <img src="{{ asset('image/all/homes.gif') }}" alt="homes"
                                            style="height: 800px;width: 800px;border-radius: 30px;border: 2px solid rgb(16, 16, 17);margin-left: -7px;box-shadow: 5px cornflowerblue ">
                                        ...
                                        <div class="col-xl-6 col-lg-6 text-center text-lg-left">
                                            <div class="copyright-text">
                                                <p>Copyright &copy; 2023, All Right Reserved <a
                                                        href="https://github.com/ZeadShalaby">Zead
                                                        Shalaby</a></p>
                                            </div>
                                        </div>
