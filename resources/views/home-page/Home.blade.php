          ...
          <section class="hero text-center" aria-label="home" id="home">
            ...
            <ul class="hero-slider" data-hero-slider>
              ...
              <li class="slider-item" data-hero-slider-item>
                ...
                <div class="slider-bg">
                  <img src="{{URL('image/home/hero-slider-2.jpg')}}" width="1880" height="950" alt="" class="img-cover">
                </div>
            ...
            <a href="#" class="hero-btn has-after">
              <img src="{{URL('image/home/hero-icon.png')}}" width="48" height="48" alt="booking icon">
                  ...
                  <div class="service-card">
                    ...
                    <a href="#" class="has-before hover:shine">
                      <figure class="card-banner img-holder" style="--width: 285; --height: 336;">
                        <img src="{{URL('image/home/service-1.jpg')}}" width="285" height="336" loading="lazy" alt="Breakfast"
                          class="img-cover">
                      </figure>
                    </a>
      ...
      <footer class="footer section has-bg-image text-center"
        ...
        <div class="container">
          ...
          <div class="footer-bottom">
            ...
            <p class="copyright">
              &copy; 2023 SRNZ. All Rights Reserved | Crafted by <a href="https://github.com/ZeadShalaby/SRNZ_PROJECT_SYSTEM"
                target="_blank" class="link">codeSRNZ</a>
            </p>
