...
<body>
    ...
    <div id="divshow" style="visibility: hidden;">
        ...
        <div class="main-content">
                            ...
                            <a class="nav-link pr-0" href="#" role="button" data-toggle="dropdown"
                                ...
                                <div class="media align-items-center" style="  margin-top: 35px;">
                                    ...
                                    <div class="media-body ml-2 d-none d-lg-block">
                                        <span class="mb-0 text-sm  font-weight-bold">{{ $SeCustomer->name }}</span>
                                    </div>
                                </div>
                            </a>
            ...
            <!-- Page content -->
            <form action="{{ route('users.update', $SeCustomer->id) }}" name="formseting" method="post"
                            ...
                            <div class="card card-profile shadow">
                                ...
                                <div class="card-body pt-0 pt-md-4">
                                    ...
                                    <div class="text-center">
                                        ...
                                        <div class="h5 font-weight-300" style="color: rgb(143, 141, 141)">
                                            <i class="ni location_pin mr-2"></i>Bucharest,
                                            Romania
                                        </div>
                                ...
                                <div class="animate">
                                    <div class="loader" style="--bg: hsl(185.97889774641104, 100%, 85%)">
                                        <div class="dot" style="--index: 0">
                                        </div>
                                        <div class="dot" style="--index: 1">
                                        </div>
                                        <div class="dot" style="--index: 2">
                                        </div>
                                        <div class="dot" style="--index: 3">
                                        </div>
                                        <div class="dot" style="--index: 4">
                                        </div>
                                        <div class="dot" style="--index: 5">
                                        </div>
                                        <div class="dot" style="--index: 6">
                                        </div>
                                        <div class="dot" style="--index: 7">
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="col-xl-6 col-lg-6 text-center text-lg-left">
                                        <div class="copyright-text">
                                            <p>Copyright
                                                ...
                                                Right
                                                Reserved
                                                <a href="https://github.com/ZeadShalaby">Zead
                                                    Shalaby</a>
                                            </p>
                                        </div>
                                    </div>
