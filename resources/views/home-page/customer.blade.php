...
<body>
   ...
   <div id="divshow" style="visibility: hidden;">
    ...
    <div class="main-content">
          ...
          <div class="container-fluid d-flex align-items-center">
            <div class="row" style="margin-left: 120px;margin-top: -20px;">
              <div class="col-lg-7 col-md-10">
                <h1 class="display-2 text-white">Hello {{$SeCustomer->name}}</h1>
        ...
        <!-- Page content -->
        <form action="{{route('users.update',$SeCustomer->id)}}" name="formseting" method="post" enctype="multipart/form-data">
          @csrf
          @method('put')
