    ...
    <div id="divshow" style="visibility: hidden;">
        ...
        <div class="main-content">
                    ...
                    <form class="navbar-search navbar-search-dark form-inline mr-3 d-none d-md-flex ml-lg-auto">
                        <div id="search">
                            <svg viewBox="0 0 420 60" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <g class="magnifier">
                                    <circle class="glass" />
                                    <line class="handle" x1="32" y1="32" x2="44" y2="44">
                                    </line>
                                </g>
                            ...
                            <a class="nav-link pr-0" href="#" role="button" data-toggle="dropdown"
                                ...
                                <div class="media align-items-center" style="  margin-top: 35px;">
                                    <span class="avatar avatar-sm rounded-circle" style="  margin-top: -5px;">
                                        ...
                                        @else
                                            <img src="{{ asset('image/users/' . $users->profile_photo) }}"
                                                alt="Image users">
                                        @endif
                                    </span>
            ...
            <div class="header pb-8 pt-5 pt-lg-8 d-flex align-items-center"
                style="min-height: 600px; background-image: url({{ asset('image/all/gback.svg') }}); background-size: 50%; background-position: center left;background-color: #000000;">
                <!-- Mask -->
            ...
            <!-- Page content -->
            <form
                @if ($users->role == 2) action="{{ route('registration.update', $users->id) }}"@else action="{{ route('users.update', $users->id) }}" @endif
                name="formseting" method="post" enctype="multipart/form-data">
                @csrf
                @method('put')
                                                ...
                                                @if (isset($users->profile_photo))
                                                    <div class="profile-pic">
                                                        <label class="-label" for="file">
                                                            <span class="glyphicon glyphicon-camera"><img
                                                                    class="hover"
                                                                    src="{{ asset('image/all/camera.png') }}"
                                                                    alt="camera"></span>
                                                        </label>
                                                        <input id="file" name="profile_photo" type="file"
                                                            value="{{ $users->profile_photo }}" />
                                                        <img src="{{ asset('image/all/profile.png') }}"
                                ...
                                <div class="card-body pt-0 pt-md-4">
                                    <div class="row">
                                        <div class="col">
                                            <div class="card-profile-stats d-flex justify-content-center mt-md-5">
                                                <div>
                                                    <span class="heading"
                                                        style="color: rgb(190, 40, 120)">{{ $CountOrders }}</span>
                                                    <span class="description">orders</span>
                                                </div>
                                                <div>
                                                    <span class="heading"
                                                        style="color: rgb(190, 40, 120)">{{ $CountFav }}</span>
                                    ...
                                    <div class="text-center">
                                        ...
                                        <div class="h5 mt-4" style="color: rgb(143, 141, 141)">
                                            <i class="ni business_briefcase-24 mr-2"></i>Solution Manager - Creative
                                            Tim Officer
                                        </div>
                                        ...
                                        <hr class="my-4">
                                        <p style="color: rgb(143, 141, 141)">Ryan — the name taken by Melbourne-raised,
                            ...
                            <div class="card bg-secondary shadow">
                                ...
                                <div class="card-header bg-blue border-0">
                                    <div class="row align-items-center">
                                        <div class="col-8">
                                            <h3 class="mb-0" style="color: azure;font-weight: bold">
                                                @if ($users->role == $check)
                                                    Gender : Admin
                                                @else
                                                    Gender : Customer
                                        ...
                                        <div class="col-4 text-right">
                                            <a href="#!" user_id='{{ $users->id }}'
                                                class="btn btn-sm btn-primary"
                                                style="background-color: #0b1526;"><button name="setting"
                                                    style="color: white;background-color: black;font-weight: bold;border: none;cursor: pointer;">Settings</button>
                                            </a>
                                        </div>
                                    </div>
                                </div>
                                            ...
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="email" id="input-email"
                                                        ...
                                                        placeholder="jesse@example.com" value="{{ $users->email }}">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-lg-6">
                                                <div class="form-group focused">
                                                    <label class="form-control-label" for="input-first-name">Gmail
                                                        Address</label>
                                                    <input type="email" id="input-first-name"
                                                        class="form-control form-control-alternative" name="gmail"
                                                        placeholder="Email Address" value="{{ $users->gmail }}">
                                                </div>
                                            </div>
                                            <div class="col-lg-6">
                                                <div class="form-group focused">
                                                    <label class="form-control-label"
                                                        for="input-last-name">Password</label>
                ...
                <div class="row">
                    <div class="col-xl-6 col-lg-6 text-center text-lg-left">
                        <div class="copyright-text">
                            <p>Copyright &copy; 2023, All Right Reserved <a href="https://github.com/ZeadShalaby">Zead
                                    Shalaby</a></p>
                        </div>
                    </div>
