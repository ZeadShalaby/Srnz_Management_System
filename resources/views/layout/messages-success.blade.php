...
<body>
    ...
    <div class="notification">
        ...
        <div class="notification__message message--info" id="success">
            <h1 style="color: rgb(0, 0, 0);font-weight:bold;">Info</h1><span
                style="font-weight:bold;font-size:13px;color:black">Srnz : Wow Your Back Again Have A Nice Day</span>
            ...
            <span style="color: rgb(255, 106, 0);font-weight:bold;font-size:15px">My Dear :<span
                    ...
                    @if (!isset($SeAdmin) && !isset($SeCustomer))
                        <span style="color: rgb(255, 106, 0);font-weight:bold;font-size:15px">Done Sir Update
                            Successfully</span>
                    @else
                        @isset($SeAdmin)
                            {{ $SeAdmin->name }}
