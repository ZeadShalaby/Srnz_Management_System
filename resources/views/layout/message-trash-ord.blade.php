...
<body>
    ...
    <div class="notification">
        ...
        <div class="notification__message message--info" id="success_msg" style="display: none">
         ...
         <span style="color: rgb(255, 106, 0);font-weight:bold;font-size:15px">My Sir :<span style="color: rgb(255, 106, 0);font-weight:bold;font-size:15px">  @if(isset($SeAdmin)){{$SeAdmin->name}} @else{{$SeCustomer}} @endif</span></span>
