...
<body>
    ...
    <div class="notification">
        ...
        <div class="notification__message message--info" id="success">
         ...
         <span style="color: rgb(255, 106, 0);font-weight:bold;font-size:15px">SIR :<span style="color: rgb(255, 106, 0);font-weight:bold;font-size:15px"> @isset($SeAdmin)  {{$SeAdmin->name}} @else @isset($SeCustomer) {{$SeCustomer->name}}
          @endisset @endisset 
