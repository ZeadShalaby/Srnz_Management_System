...
-->
        ...
        <div class="notification__message message--info">
            ...
            <span style="font-weight:bold;font-size:13px">Name alreday Exist Chose Another Name ..</span>
            <span style="font-weight:bold;font-size:13px">{{ session('error') }}</span>


            <span style="color: rgb(255, 106, 0);font-weight:bold;font-size:15px">My Dear <span
                    style="color: rgb(255, 106, 0);font-weight:bold;font-size:15px">
                    @if (isset($SeCustomer))
                        {{ $SeCustomer->name }}
                    @endif
                </span></span>
            ...
            <button aria-labelledby="button-dismiss" id="remove">
    ...
    <div id="email_error_msg" style="display: none;">

        <div class="notification__message message--info">
            <h1 style="color: rgb(0, 0, 0);font-weight:bold;">Info</h1>

            <span style="font-weight:bold;font-size:13px">Email alreday Exist Chose Another Email ..</span>
            <span style="color: rgb(255, 106, 0);font-weight:bold;font-size:15px">My Dear <span
                    style="color: rgb(255, 106, 0);font-weight:bold;font-size:15px"></span></span>
    ...
    <script>
        ...
        */
        ...
        function generateMessage() {
            ...
            const delay = Math.floor(Math.random() * 1000) + 1300;
