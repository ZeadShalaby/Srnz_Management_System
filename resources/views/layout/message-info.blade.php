...
<body>
    ...
    <div class="notification">
        ...
        -->
        <div class="notification__message message--info" id="Delete_Favourites" style="display: none;">
          <h1 style="color: rgb(0, 0, 0);font-weight:bold;">Info</h1>
          <span style="color: rgb(255, 106, 0);font-weight:bold;font-size:15px">My Dear :<span style="color: rgb(255, 106, 0);font-weight:bold;font-size:15px">  {{$SeCustomer->name}}</span></span>
    ...
    const messageText = [
        ' Youre Deleted Favourites Sir See You Soon ...!! '
    ];
