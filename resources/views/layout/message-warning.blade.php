...
<body>
    ...
    <div class="notification" >
        ...
        <div class="notification__message message--info">
         ...
         <span style="color: rgb(255, 106, 0);font-weight:bold;font-size:15px">My Dear :  <span style="color: rgb(255, 0, 0);font-weight:bold;font-size:15px"></span>{{session('error')}}</span>
