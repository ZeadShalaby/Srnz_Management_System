...
<div class="notification__message message--info">
    <h1 style="font-weight:bold;font-size:15px">Info</h1>
    <p style="font-weight:bold;font-size:15px">Lorem ipsum dolor sit amet consectetur adipisicing.</p>
...
@if(auth()->user()->role =='2')
    <div >
      <form action="{{route('registration.destroy',$SeCustomer->id)}}" method="POST">
          @csrf
          @method('DELETE')
          <button  account_name={{$SeCustomer->id}} class="delete_account  " ><i class="fa fa-trash" style="color: rgb(248, 0, 0);margin-top: -5px;cursor: pointer"></i></button>
      </form>
  </div>
  @else
