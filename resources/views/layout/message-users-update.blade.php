...
<body>
    ...
    <div class="notification">
        ...
        <div class="notification__message message--info" >
         ...
         <span style="color: rgb(255, 106, 0);font-weight:bold;font-size:15px">Done Sir :<span style="color: rgb(255, 106, 0);font-weight:bold;font-size:15px">{{$SeAdmin->name}}
    ...
    'UPDATE USERS SUCCESSFULLY DONE WORk .'
