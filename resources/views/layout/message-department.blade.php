...
<div id="success_msg" style="display: none;">
    ...
    <div class="notification__message message--info">
     ...
     <span style="color: rgb(255, 106, 0);font-weight:bold;font-size:15px">My Dear :<span style="color: rgb(255, 106, 0);font-weight:bold;font-size:15px">{{$SeAdmin->name}}</span></span>
...
const messageText = [
    'DELETE : Departments SUCCESSFULLY Have A NICE DAy . '
...
function generateMessage() {
  ...
  const delay = Math.floor(Math.random() * 100) + 1300;
