            ...
            <div class="login" style="margin-top:-80px">
                <div class="login__content">
                    ...
                    <div class="login__forms">
                        <form action="{{ route('departments.update', $departments->id, $departments->img) }}"
                            class="login__registre" enctype="multipart/form-data" method="post">
                            @csrf
                            @method('put')
                            ...
                            <div class="login__box">
                                ...
                                <input class="login__input" type="text" placeholder="Name" name="name"
                            ...
                            <div class="login__box">
                                ...
                                <input class="login__input" type="text" placeholder="code" name="code"
