...
<body>
    ...
    <h1>Departments
        <a href="{{ route('departments.create') }}"> <img width="50px" height="50px"
                                    ...
                                    <div class="description-switch__outer">
                                        <div class="description-switch__inner">
                                            ...
                                            <button department_id={{ $department->id }}
                                                class="delete_btn btn btn-danger"><i class="fa fa-trash"
                                                    id="delete"></i></button>
                                            <a href="{{ route('departments.edit', $department->id) }}"
                                                class="edit_btn -info"> <i class="fa fa-edit" id="edit"></i> </a>


                                            <p>{{ $department->name }}</p>

                                            <a href="{{ route('departments.show', $department->id) }}">
                                                <!--target="_blank" open link in new page -->
