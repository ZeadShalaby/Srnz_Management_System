        ...
        <div class="container" style="margin-left: -800px">
            <form id="form" class="form">
                ...
                <div class="form-control" id="Name">
                    ...
                    <input id="username" class="form-control" type="text" placeholder="UserName" name="name"
                        value="{{ old('name') }}">
                    <small>Error message</small>
                </div>
                <div class="form-control" id="Email">
                    <label for="email">Email</label>
                    <input id="email" class="form-control" type="text" placeholder="Enter/Email" name="email"
                        value="{{ old('email') }}">
                    <small>Error message</small>
                </div>
                <div class="form-control" id="Gmail">
                    <label for="password2">Gmail</label>
                    <input id="gmail" class="form-control" type="text" placeholder="Enter/Gmail" name="gmail"
                        value="{{ old('gmail') }}">
                    <small>Error message</small>
                </div>
                <div class="form-control" id="Phone">
                    <label for="password2">Phone</label>
                    <input id="phone" class="form-control" type="text" placeholder="Enter/Phone" name="phone"
                        value="{{ old('phone') }}">
                    <small>Error message</small>
                </div>
