...
<body>
    ...
    <div class="background3">
        ...
        <div class="shape3">
            <div class="forget"><a href="file:///D:/idea%20not%20field/Project_SW2/forget.html"
                    class="forget-letter"></a></div>
        </div>
        <div class="shape3">
            <div class="project"><a href="file:///D:/idea%20not%20field/Project_SW2/card%20move%20away.html"
                    class="team_project"></a></div>
    ...
    <form method="post" action="{{ url('/login/checklogin') }}">
        ...
        <br>
        <a href="{{ route('forgetindex') }}" style="text-decoration: none;color: rgb(0, 183, 255)"> forget passsword
            ..?</a>
    ...
    <a href="{{ route('registration.create') }}"> <img width="50px" height="50px"
            src="{{ URL('image/all/add1.png') }}" alt="add"> </i>
    </a>
</body>
