       ...
       <div class="containers" >
        @endif
         ...
         <div class="wrapper">
            ...
            <div class="title">
            <p>@isset($interested->order->name){{$interested->order->name}}@else{{'null ordername'}}@endisset</p>
            </div>
            <div class="place">
                <span>{{$interested->order->price}}<span style="color: green;font-weight: bold"> $</span></span>
