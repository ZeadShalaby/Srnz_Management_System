        ...
        <div class="departments">
            @foreach ($Departments as $department)
                <a href="{{ route('registration.show', $department->id) }}"
                    ...
                    <div class="contains" style="margin-top: 200px">
                        <div class="boxes">
                    ...
                    <div class="container">
                        <div class="box">
                            ...
                            <div class="under_imgs">
                                @isset($order->view)
                                    <img src="{{ url('image\all\view.png') }}" alt="vieweer" style="width: 30px">
                                    {{ '' }}{{ $order->view }}
                                @else
                                ...
                                <div style="margin-top: -18px">
                                    <button order_id={{ $order->id }} id='delete' class="delete_btn"
                                        style="margin-left: 150px;"><i class="fa fa-trash"></i></button>
                                </div>
                                <br><br>
                            </div>
                        </div>
